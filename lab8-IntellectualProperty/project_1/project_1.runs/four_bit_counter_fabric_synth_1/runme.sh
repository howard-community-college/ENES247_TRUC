...
HD_PWD='C:/Users/SET253-21U.HCCMAIN/Documents/GitHub/ENES247_TRUC/lab8-IntellectualProperty/project_1/project_1.runs/four_bit_counter_fabric_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_counter_fabric.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_counter_fabric.tcl
