...
//    input bankSwitch, //bank or row of 16 LED's 
    ...
    //input creator ... 64 bit counter
    longint c_input=451263789; //this creates a variable called c_input with 32 bits and initialized to 0 
              //in hex is 1AE5 BD2D
              //in decimal is 451,263,789
              //in binary is 0001 1010 1110 0101 1011 1101 0010 1101
    reg [2:0] segement;          
    //clock for 64 bit counter
   ...
   always_comb @ (c_input[26])
   
    
    
    assign LED[7:0] = c_input[33:26];
    ...
    reg [31:0] c32;
    assign c32 = c_input[55:26];
    assign hex_to_display = c32[4*segment +: 4]; // 3 bits of anode_select, grab 4 bits of c_input and put them in hex_to_display
