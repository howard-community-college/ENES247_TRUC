...
HD_PWD='C:/Users/SET253-10U.HCCMAIN/Documents/GitHub/ENES247_TRUC/lab11-ASM/lab_Asm_chart/lab_Asm_chart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asm_chart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asm_chart.tcl
