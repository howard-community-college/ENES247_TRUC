...
HD_PWD='C:/Users/SET253-10U.HCCMAIN/Documents/GitHub/ENES247_TRUC/lab11-ASM/lab_Asm_chart/lab_Asm_chart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asm_chart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asm_chart.tcl -notrace
